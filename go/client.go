// Package iplookup provides a Go client for the IP Lookup API.
//
// For more information, visit: https://iplookup.apiverve.com?utm_source=go&utm_medium=readme
package iplookup
...
const (
	baseURL        = "https://api.apiverve.com/v1/iplookup"
	defaultTimeout = 30 * time.Second
)

// Client is the IP Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new IP Lookup API client.
...
// Execute makes a request to the IP Lookup API with typed parameters.
//
...
//   - ip (required): string - The IP address for which you want to get the location data (e.g., 173.172.81.20) [format: ip]
