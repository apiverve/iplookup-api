 ...
 * ```
 *
 * @see https://iplookup.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/iplookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\IplookupClient] {$message}\n";
        }
    }
}
