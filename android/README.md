...
```gradle
dependencies {
    implementation 'com.github.apiverve:iplookup-api:1.1.12'
}
```
...
```java
import com.apiverve.iplookup.IPLookupAPIClient;
import com.apiverve.iplookup.APIResponse;
import com.apiverve.iplookup.APIException;

// Initialize the client
IPLookupAPIClient client = new IPLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/iplookup](https://docs.apiverve.com/ref/iplookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/iplookup](https://docs.apiverve.com/ref/iplookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/iplookup-api/issues)
